...
# Synquery Whitepaper {#synquery-whitepaper}

_This introductory paper was originally published in 2021 by Yoshitaka Sakamoto, the proposer of [Synquery Crypto Network](/what-is-synquery/), before the network is activated publicly. It's worth noting that Synquery, like many community-driven, open-source software projects, has evolved since its initial inception._

_While several years old, we maintain this paper because it continues to serve as a useful reference and an accurate representation of Synquery and its vision. To learn about the latest developments of Synquery, and how changes to the protocol are made, we recommend [this guide](/learn/)._
