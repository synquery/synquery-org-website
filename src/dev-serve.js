/**
 * [synquery-org-website] dev-serve.js
 * serve-handler と websockets, chokidar を使ってライブサーバーを提供する
 * https://github.com/vercel/serve/blob/main/bin/serve.js
 * Netlify 自体は netlify.toml に public が指定されているので、build した結果が public フォルダに格納される必要がある。
 * Serve も -s public により public フォルダを見るので、チェック前に build が必要。
 */
